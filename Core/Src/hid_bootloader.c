...
//				}
		...
		else 
		{
			...
			if (currentPageOffset == SECTOR_SIZE) 
			{
				...
				//ST usb������쳣
				//USBD_CUSTOM_HID_SendReport(&hUsbDeviceFS, USB_TX_Buffer, sizeof(USB_TX_Buffer)); // ʹ��AC6�������� AC5��Ӳ������
				USBD_CUSTOM_HID_SendReport(&hUsbDeviceFS, CMD_DATA_RECEIVED, sizeof(CMD_DATA_RECEIVED)); // ʹ��AC6�������� AC5��Ӳ������
			}
		}
	}
}
